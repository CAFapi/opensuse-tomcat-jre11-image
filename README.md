...
This project builds on the openSUSE Java 11 image [here](https://github.com/CAFapi/opensuse-base-images/tree/main/opensuse-java21-images) to build two pre-configured Tomcat Docker images
...
They can be used as a base images for hosting web projects which use Java technologies such as Java Servlets or JavaServer Pages.
